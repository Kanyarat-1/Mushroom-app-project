...
class MushroomEdiblePage extends StatefulWidget {
  const MushroomEdiblePage({Key? key}) : super(key: key);
...
class _MushroomEdiblePageState extends State<MushroomEdiblePage> {
  ...
  Future<void> getrecord() async {
    String uri = "https://mushroomroom.000webhostapp.com/Test/view_edible.php";
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Mushroom Edible")),
      body: isLoading
